...
namespace ImmediateUI.immui
{
    ...
    {
        //Mouse
        public bool[] MouseDown = new bool[(int)MouseButtons.COUNT];
        public Vector2i MousePos;
        public Vector2 Drag;
        //Keyboard
        public BitArray Keys = new((int)KeyboardKeys.LastKey + 1);
        public List<char> InputedChars = new();
        ...
        public void AddKeyEvent(KeyboardKeys Key , bool Down)
        {
            Keys[(int)Key] = Down;
        }
    }
