...
namespace VoxelPrototype.client.utils.StbTrueType
{
	...
	{
		public static void* stbtt__hheap_alloc(stbtt__hheap* hh, int size, void* userdata)
		{
			...
			if (hh->num_remaining_in_head_chunk == 0)
			{
				...
				var c = (stbtt__hheap_chunk*)CRuntime.malloc(sizeof(stbtt__hheap_chunk) +
															  size * count);
				if (c == null)
					return null;
				c->next = hh->head;
			...
			return (sbyte*)hh->head + sizeof(stbtt__hheap_chunk) + size * hh->num_remaining_in_head_chunk;
		}
		...
		{
			var z = (stbtt__active_edge*)stbtt__hheap_alloc(hh, sizeof(stbtt__active_edge), userdata);
