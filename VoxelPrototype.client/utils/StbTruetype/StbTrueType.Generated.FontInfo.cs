...
namespace VoxelPrototype.client.utils.StbTrueType
{
    unsafe partial class StbTrueType
	{
		...
		public static int stbtt__GetGlyphShapeT2(stbtt_fontinfo info, int glyph_index, stbtt_vertex** pvertices)
		{
			...
			{
				*pvertices = (stbtt_vertex*)CRuntime.malloc((count_ctx.num_vertices * sizeof(stbtt_vertex)));
		...
		public static int stbtt__GetGlyphShapeTT(stbtt_fontinfo info, int glyph_index, stbtt_vertex** pvertices)
		{
			...
			*pvertices = null;
			...
			if (numberOfContours > 0)
			{
				...
				vertices = (stbtt_vertex*)CRuntime.malloc((m * sizeof(stbtt_vertex)));
				if (vertices == null)
					return 0;
				next_move = 0;
				flagcount = 0;
			...
			else if (numberOfContours < 0)
			{
				...
				while (more != 0)
				{
					...
					m = MathF.Sqrt(mtx[0] * mtx[0] + mtx[1] * mtx[1]);
					n = MathF.Sqrt(mtx[2] * mtx[2] + mtx[3] * mtx[3]);
					...
					if (comp_num_verts > 0)
					{
						...
						tmp = (stbtt_vertex*)CRuntime.malloc(((num_vertices + comp_num_verts) *
																	   sizeof(stbtt_vertex)));
						if (tmp == null)
						{
							if (vertices != null)
						...
						if (num_vertices > 0 && vertices != null)
							CRuntime.memcpy(tmp, vertices, (num_vertices * sizeof(stbtt_vertex)));
			...
			float shift_x, float shift_y, int glyph, int* width, int* height, int* xoff, int* yoff)
		{
			...
			if (gbm.w != 0 && gbm.h != 0)
			{
				gbm.pixels = (byte*)CRuntime.malloc((gbm.w * gbm.h));
				if (gbm.pixels != null)
				{
					gbm.stride = gbm.w;
