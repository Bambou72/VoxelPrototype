...
namespace VoxelPrototype.client.rendering
{
    ...
    public class Shader
    {
        ...
        public Shader(string vert, string frag, bool nopath)
        {
            // There are several different types of shaders, but the only two you need for basic rendering are the vertex and fragment shaders.
            // The vertex shader is responsible for moving around vertices, and uploading that data to the fragment shader.
            //   The vertex shader won't be too important here, but they'll be more important later.
        ...
        public Shader(string vert, string frag, string geo, bool nopath)
        {
            // There are several different types of shaders, but the only two you need for basic rendering are the vertex and fragment shaders.
            // The vertex shader is responsible for moving around vertices, and uploading that data to the fragment shader.
            //   The vertex shader won't be too important here, but they'll be more important later.
        ...
        public void SetFloatA(string name, float data)
        {
            GL.UseProgram(Handle);
        ...
        public void SetMatrix4A(string name, Matrix4 mat)
        {
            GL.UseProgram(Handle);
            GL.UniformMatrix4(GL.GetUniformLocation(Handle, name), false, ref mat);
        }
        public void SetMatrix4NoTranspose(string name, Matrix4 data)
        {
            GL.UseProgram(Handle);
        ...
        public void SetVector3A(string name, Vector3 data)
        {
            GL.UseProgram(Handle);
